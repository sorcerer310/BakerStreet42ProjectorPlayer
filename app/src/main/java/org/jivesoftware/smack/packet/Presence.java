 ...
 * <ul>
 *      <li>{@link Type#available available} -- (Default) indicates the user is available to
 *          receive messages.
 *      <li>{@link Type#unavailable unavailable} -- the user is unavailable to receive messages.
 *      <li>{@link Type#subscribe subscribe} -- request subscription to recipient's presence.
 *      <li>{@link Type#subscribed subscribed} -- grant subscription to sender's presence.
 *      <li>{@link Type#unsubscribe unsubscribe} -- request removal of subscription to
 *          sender's presence.
 *      <li>{@link Type#unsubscribed unsubscribed} -- grant removal of subscription to
 *          sender's presence.
 *      <li>{@link Type#error error} -- the presence packet contains an error message.
 * </ul><p>
 *
...
public class Presence extends Packet {
     ...
     * to be the same thing as {@link Mode#available}.
     *
     * @param mode the mode.
     */
